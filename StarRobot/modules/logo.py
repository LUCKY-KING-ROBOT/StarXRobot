...
from StarRobot import BOT_NAME, BOT_USERNAME, OWNER_ID, telethn
from StarRobot.events import register
...
async def lego(event):
    ...
    try:
        ...
        fnt = glob.glob("./StarRobot/resources/fonts/*")
