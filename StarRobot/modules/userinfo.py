...
import StarRobot.modules.sql.userinfo_sql as sql
...
from StarRobot import telethn as StarTelethonClient
from StarRobot.__main__ import STATS, TOKEN, USER_INFO
from StarRobot.modules.disable import DisableAbleCommandHandler
from StarRobot.modules.helper_funcs.chat_status import sudo_plus
from StarRobot.modules.helper_funcs.extraction import extract_user
from StarRobot.modules.sql.afk_sql import check_afk_status, is_afk
from StarRobot.modules.sql.global_bans_sql import is_user_gbanned
from StarRobot.modules.sql.users_sql import get_user_num_chats
            ...
            message.reply_document(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "⚡ᴅᴇᴠᴇʟᴏᴘᴇʀ⚡", url="https://t.me/DX_LUCKY_143"
                            ),
                            InlineKeyboardButton(
                                "💫 ɢʀᴏᴜᴩ 💫", url="https://t.me/DXinfo143"
                            ),
                        ],
                        [
                            InlineKeyboardButton(
...
def stats(update: Update, context: CallbackContext):
    stats = "<b> ᴄᴜʀʀᴇɴᴛ sᴛᴀᴛs ᴏғ sᴛᴀʀ ✘ ʀᴏʙᴏᴛ:</b>\n" + "\n".join(
